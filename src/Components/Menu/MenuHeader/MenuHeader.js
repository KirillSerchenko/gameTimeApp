...
class MenuHeader extends Component {
   ...
   render() {
     return (
      ...
      <span style={{fontWeight:"normal",position:"relative",left:"3em",top:"-1em",float:"right",fontSize:"12px",color:"white",textShadow:"none",display:"block"}} >{this.props.username.currentUser.Username}</span>
