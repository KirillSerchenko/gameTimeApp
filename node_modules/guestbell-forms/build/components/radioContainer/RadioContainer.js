...
function (_React$PureComponent) {
  _inherits(RadioContainer, _React$PureComponent);

  function RadioContainer(props) {
    _classCallCheck(this, RadioContainer);

    return _possibleConstructorReturn(this, _getPrototypeOf(RadioContainer).call(this, props));
  }

  _createClass(RadioContainer, [{
    key: "render",
    value: function render() {
      return React.createElement(_InputGroup.default, {
        title: this.props.title
      }, React.createElement("div", {
        className: "input__base radio-input__container \n                    ".concat(this.props.horizontal ? 'radio-input__container--horizontal' : '', " \n                    ").concat(this.props.className ? this.props.className : ''),
...
var _default = RadioContainer;
exports.default = _default;
//# sourceMappingURL=RadioContainer.js.map