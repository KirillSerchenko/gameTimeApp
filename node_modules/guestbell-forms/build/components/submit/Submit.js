...
exports.default = exports.Submit = exports.SubmitRaw = void 0;
...
function (_BaseInput) {
  ...
  _createClass(SubmitRaw, [{
    ...
    value: function render() {
      ...
      return React.createElement(_Button.Button, _extends({}, this.props, {
        ...
        tooltip: this.props.tooltip ? this.props.tooltip : this.props.showValidationSummaryTooltip && !this.props.formContext.isFormValid && React.createElement(_FormValidationSummary.FormValidationSummaryRaw, {
          title: "Hang on",
          footer: "... needs fixing",
          containerClassName: "",
...
_defineProperty(SubmitRaw, "defaultProps", Object.assign({}, _BaseInput2.BaseInput.defaultProps, {
  validateForm: true,
  ignoreContext: true,
...
var Submit = (0, _withFormContext.withFormContext)(SubmitRaw);
