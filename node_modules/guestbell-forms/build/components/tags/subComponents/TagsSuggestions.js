...
function (_React$PureComponent) {
  ...
  function Suggestions() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSelected", function (tag) {
      return function () {
        return _this.props.onSelected(tag);
      };
    });
  ...
  _createClass(Suggestions, [{
    ...
    value: function render() {
      ...
      return this.props.isVisible ? React.createElement("div", {
        className: "tags-input__suggestions"
      }, React.createElement("ul", null, this.props.AddNewTagComponent, this.props.loading && this.props.LoadingComponent && React.createElement("li", {
      ...
      }), !this.props.loading && this.props.EmptyComponent && this.props.tags.length === 0 && !this.props.allowNew && React.createElement("li", {
        className: "w-100 text-center p-2"
...
var SuggestionsWrapped = (0, _reactOnclickoutside.default)(Suggestions);
