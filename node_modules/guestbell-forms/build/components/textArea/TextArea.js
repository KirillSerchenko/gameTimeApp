...
exports.default = exports.TextArea = exports.TextAreaRaw = void 0;
...
/*#__PURE__*/
function (_BaseInput) {
  _inherits(TextAreaRaw, _BaseInput);
  ...
  function TextAreaRaw(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TextAreaRaw).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "elemRef", function (elem) {
      return _this.props.inputRef && _this.props.inputRef(elem);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onContainerClick", function (e) {
  ...
  _createClass(TextAreaRaw, [{
    ...
    value: function render() {
      ...
      return React.createElement(_InputGroup.default, {
      ...
      }, React.createElement(_reactAutosizeTextarea.default, {
        ref: this.elemRef,
        ...
        className: "bar"
      }), this.renderDefaultValidation(), this.props.label && React.createElement("label", null, this.renderLabel())));
    }
  }, {
    key: "focus",
...
_defineProperty(TextAreaRaw, "defaultProps", Object.assign({}, _BaseInput2.BaseInput.defaultProps, {
  type: 'text',
  placeholder: '',
...
var TextArea = (0, _withFormContext.withFormContext)(TextAreaRaw);
